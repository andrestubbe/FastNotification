# FastNotification Roadmap 🗺️

**Vision:** To provide the fastest possible native primitives for notifications by aggressively bypassing bottlenecks in standard Java.
